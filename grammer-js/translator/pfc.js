module.exports = {
    ...
    "ABSTRACTION := leftParenthesis rightParenthesis arrow EXP": "sys_abstraction(sys_void(), <%= $4%>)",
    "ABSTRACTION := leftParenthesis LIST_VARIABLES rightParenthesis arrow EXP": "sys_abstraction(<%= $2%>, <%= $5%>)",
